...
#
#############################################################
MARSHMALLOW_H_VERSION = 20130420
MARSHMALLOW_H_SOURCE = marshmallow_h-$(MARSHMALLOW_H_VERSION)-src.tar.xz
MARSHMALLOW_H_SITE = http://downloads.marshmallow.me
...
MARSHMALLOW_H_DEPENDENCIES = alsa-lib zlib libpng libogg libvorbis rpi-userland
...
define MARSHMALLOW_H_INSTALL_TARGET_CMDS
	$(HOST_DIR)/usr/bin/cmake -DCMAKE_INSTALL_PREFIX=$(TARGET_DIR)/usr/games/marshmallow_h -DCOMPONENT=runtime -P "$(@D)/cmake_install.cmake"
...
define MARSHMALLOW_H_INSTALL_STAGING_CMDS
	$(HOST_DIR)/usr/bin/cmake -DCMAKE_INSTALL_PREFIX=$(STAGING_DIR)/usr/games/marshmallow_h -DCOMPONENT=development -P "$(@D)/cmake_install.cmake"
	mv $(@D)/install_manifest_development.txt $(@D)/install_manifest_development_staging.txt

	$(HOST_DIR)/usr/bin/cmake -DCMAKE_INSTALL_PREFIX=$(STAGING_DIR)/usr/games/marshmallow_h -DCOMPONENT=runtime -P "$(@D)/cmake_install.cmake"
