...
You can test drive rpi-buildroot by following the instructions below:
	...
	wget https://github.com/downloads/gamaral/rpi-buildroot/sdcard.img.xz
	xz -d sdcard.img.xz
...
use with the test-drive image, download and usage instructions below:
	...
	wget https://github.com/downloads/gamaral/rpi-buildroot/rpi-buildroot-toolchain.tar.xz
